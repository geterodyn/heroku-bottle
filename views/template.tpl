...
<head>
	...
	<link 
		...
		/>
		<link rel="stylesheet" type="text/css" href="http://127.0.0.1:8090/styles.css">
		<script
...
<script src="http://127.0.0.1:8090/helpers.js" type="text/javascript" language="javascript"></script>
</html>